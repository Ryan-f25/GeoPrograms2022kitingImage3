public class A6_house extends World {
    ...
    public void go() {
        ...
        for (int x = 0; x < 5; x++) {
            ...
            plane.teleport((int)(Math.random()*600)+200, (int)(Math.random()*600)+1);
